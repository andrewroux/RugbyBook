...
public class TicketExchangeGUI extends javax.swing.JFrame {
    ...
    private String fName, lName, ppsn, age, gender, email, phoneNo, cardNumber, month, year, ccv, carPark, meal;
    private boolean phoneOffer, emailOffer;
//    ,emptyVa,ticketNameVa,cardNumVa,monthVa,yearVa,ccvVa,cardNameVa,emailVa, phoneVa; 
    private String fullName, gameName, seatName, errorMessage;
    private int normalSeatsAvailable, businessSeatsAvailable, premiumSeatsAvailable, seatsAvailableType,quantity;
    ...
    private void initComponents() {
        ...
        HomePanel.setMaximumSize(new java.awt.Dimension(610, 426));
        HomePanel.setOpaque(false);
        HomePanel.setPreferredSize(new java.awt.Dimension(590, 426));
        ...
        summaryPanelLayout.setVerticalGroup(
            ...
            .addGroup(summaryPanelLayout.createSequentialGroup()
                .addGap(38, 38, 38)
                .addComponent(summaryScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
                .addGap(18, 18, 18)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detailsPanelLayout.createSequentialGroup()
                ...
                .addGroup(detailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, detailsPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lNameTA, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(ppsLbl)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(ppsnTA, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detailsPanelLayout.createSequentialGroup()
                                .addGroup(detailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(detailsPanelLayout.createSequentialGroup()
                                        ...
                                        .addComponent(qtyLbl)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(quantityCB, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(43, 43, 43))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, detailsPanelLayout.createSequentialGroup()
                                        .addGap(0, 0, Short.MAX_VALUE)
                                ...
                                .addGroup(detailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(totalCostDisplayLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addGap(49, 49, 49))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(HomePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 601, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(55, 55, 55)
                                .addComponent(summaryPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 601, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(HomePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 472, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(detailsPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 398, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(cardPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(summaryPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE))
                    .addComponent(welcomePanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void normalCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_normalCheckBoxActionPerformed
        ...
        seatType = new Seat(gameName,normalSeatsAvailable,businessSeatsAvailable, premiumSeatsAvailable);
        seatName = seatType.getSeatName();
        System.out.println(seatType.getNormalSeatsAvailable());
        System.out.println(normalSeatsAvailable);
        if(normalSeatsAvailable == 0) {
                normalTP.setText("Sold out!"); 
            } else {
                
              normalTP.setText("Package Includes:\n" + seatName + "\nLocation: " + seatType.getSeatArea() + "\n\n" + seatType.getSeatPrice() + "\n" + normalSeatsAvailable + " Available" );  
            }
    ...
    public boolean validation(String regex, String textField) {
   ...
   //----------------filling detail page validation methods-------------------------------//
    ...
    public void createSeatsForGames(){
        try{
            ...
            String[] games = {"Ireland v South Africa", "Ireland v South Africa & Argentina", "Ireland v South Africa & Fiji", "Ireland v South Africa, Fiji & Argentina", "Ireland v Fiji", "Supporters Club Event", "Ireland v Argentina"};
            ArrayList<Seat> listOfGames = new ArrayList<>();
            Seat game;
            for(String i: games){
                game = new Seat(i,5,15,5);
    ...
    public Boolean checkID(){
        ...
        for(Records i: details){
            if (seatType instanceof BusinessSeat && i.getPpsn().equals(ppsnTA.getText()) && i.getGameName().equals(gameCB.getSelectedItem()) && i.getSeatType().equals("Business Class Seat")) {
                return true;
            } else {
    ...
    private void premiumCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_premiumCheckBoxActionPerformed
        ...
        businessSeatsAvailable = gamesList.get(gameCB.getSelectedIndex()).getBusinessSeatAvailable();
        premiumSeatsAvailable = gamesList.get(gameCB.getSelectedIndex()).getPremiumSeatAvailable();
        seatType = new PremiumSeat(gameName, normalSeatsAvailable,businessSeatsAvailable,premiumSeatsAvailable);
        seatName = seatType.getSeatName();        
        if(premiumSeatsAvailable == 0) {
            premiumTP.setText("Sold out!"); 
        } else {  
          premiumTP.setText("Package Includes:\n" + seatName + "\nLocated in the " + seatType.getSeatArea() + "\nChoice of meal\nReserved Parking Space\nFasttrack\n" + "\n" + seatType.getSeatPrice() + "\n" + premiumSeatsAvailable + " Available");  
        }
        normalCheckBox.setSelected(false);
        normalScrollPane.setVisible(false);
    ...
    private void businessCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_businessCheckBoxActionPerformed
        ...
        businessSeatsAvailable = gamesList.get(gameCB.getSelectedIndex()).getBusinessSeatAvailable();
        premiumSeatsAvailable = gamesList.get(gameCB.getSelectedIndex()).getPremiumSeatAvailable();
        seatType = new BusinessSeat(gameName,normalSeatsAvailable, businessSeatsAvailable, premiumSeatsAvailable);
        seatName = seatType.getSeatName();
        if(seatType.getBusinessSeatAvailable() == 0) {
            businessTP.setText("Sold out!");
        } else {
           businessTP.setText("Package Includes:\n" + ((BusinessSeat)seatType).getCapacity() + " " +seatName+ "s" +  "\nLocated in the " + seatType.getSeatArea() + "\nChoice of meal\n" + "\n" + seatType.getSeatPrice() + "\n" + businessSeatsAvailable + " Available"); 
        }
    ...
    private void homePageNextBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_homePageNextBtnMouseClicked
        ...
        if(!businessCheckBox.isSelected() && !premiumCheckBox.isSelected() && !normalCheckBox.isSelected()){
            ...
            totalCostDisplayLbl.setText(String.format("€%.2f",seatType.getPrice()));
            if(seatType instanceof PremiumSeat){
                ...
                addItemsToCheckBox(((PremiumSeat)seatType).getParking(), parkCB);
                addItemsToCheckBox(((PremiumSeat)seatType).getMeal(), mealCB);
                ...
                parkLbl.setVisible(false);
                parkCB.setVisible(false);
                addItemsToCheckBox(((BusinessSeat)seatType).getMeal(), mealCB);
            } else {
                quantityCB.setVisible(true);
                qtyLbl.setVisible(true);
                mealCB.setVisible(false);
    ...
    public String isAvailableSeat( int quantity) {
        if (seatType instanceof BusinessSeat && businessSeatsAvailable-quantity < 0) {
            return "You can't purchase " + quantity + " ticket(s) there is only " + seatType.getBusinessSeatAvailable() + " available.";
            } else if(seatType instanceof PremiumSeat && premiumSeatsAvailable-quantity < 0) {
                return "You can't purchase " + quantity + " ticket(s) there is only " + seatType.getPremiumSeatAvailable() + " available.";
            } else {
                if (normalSeatsAvailable-quantity < 0) {
                    return "You can't purchase " + quantity + " ticket(s) there is only " + seatType.getNormalSeatsAvailable() + " available.";
                } else {
                    return "";
                }
            }
...
//  
       Pattern p = Pattern.compile("\\d{7}\\w{1,2}$");
        Matcher m = p.matcher(ppsnTA.getText());
        if(!m.find()){
    ...
    public String mealAndParkingDetails(String selectedMeal) {
    ...
    public void writeToTicketFile(int availableSeat){
        try{ 
	File file = new File ("tickets.txt");
	FileWriter fw = new FileWriter(file,true);
	BufferedWriter bw = new BufferedWriter(fw);
        String ticketIdLetters = (gameCB.getSelectedItem()).toString();
        System.out.println(seatType.getMaxSeatsAvailable() + " " + ticketIdLetters.replaceAll("[a-z()0-9. ]",""));
	bw.write("\t\tTicket Details\n");        
        for(int i = 0; i < quantity; i++){
            bw.write("Ticket Id: " + (seatType.getMaxSeatsAvailable()-availableSeat-i)+ticketIdLetters.replaceAll("[a-z()0-9. ]","") + "\t\tGate: " + seatType.getGate() + "\n" + "Name: " + fName + " " + lName  + "\tPassport Number: " + ppsnTA.getText() + "\n" + "Seat Area: " +seatType.getSeatArea() + " \tSeat Name: " + seatName + "\n" + mealAndParkingDetails(mealCB.getSelectedItem().toString()));

            System.out.println(seatType.getMaxSeatsAvailable()-(availableSeat-i) + "" + ticketIdLetters.replaceAll("[a-z()0-9. ]",""));
    ...
    public void createRecord() {
        ...
        if(seatType instanceof PremiumSeat){
                ...
                writeToTicketFile(seatType.getNormalSeatsAvailable());
            ...
            // Decrement the value by one because the user doesnt have the choice to buy more than one box
                ...
                writeToTicketFile(seatType.getBusinessSeatAvailable());
                records = new Records(fName,lName,ppsn,age,gender,((BusinessSeat)seatType).getCapacity(),meal,phoneNo,meal,phoneOffer,emailOffer,cardNumber,month,year,ccv,gameName, seatName);
            } else {
